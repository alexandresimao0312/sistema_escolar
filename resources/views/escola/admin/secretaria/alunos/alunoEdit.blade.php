...
<div class="container " id="abaCadastrarAlunos" role="tabpanel" aria-labelledby="Cadastrar Alunos">
    <label class="h3">Atualizar alunos</label>
    <hr>
    <form action="{{route('secretaria.alunos.update', $aluno->id)}}" method="post"  id="formCadastroAluno">
        @csrf
        @method('PUT')
      ...
      <section class="fixed-bottom" style="position:fixed; width: 97%; align-content: center; bottom:40px; right:40px; margin-top:70px;">
        <button type="submit" class="btn btn-primary" style="float: right;" id="cadastrarAluno">Atualizar Aluno</button>
